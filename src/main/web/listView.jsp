            ...
            <div class="row">
                <div class="col-xs-4">
                    <form class="form-inline">
                        <button onclick="javascript:window.location.href='add.html';" type="button" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span>新增</button>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <table class="table table-striped table-bordered">
                        <tr>
                            <td style="background-color:#3fb4c6; color:#fff;width:18%;">id</td>
                            <td style="background-color:#3fb4c6; color:#fff;width:15%;">名字</td>
                            <td style="background-color:#3fb4c6; color:#fff;width:12%;">描述</td>
                        ...
                        <s:iterator value="hospitals">
                            <tr>
                                <s:url var="get" action="/hospital/getByID">
                                    <s:param name="hospitalID">
                                        <s:property value="id"/>
                                    </s:param>
                                </s:url>

                                <s:url var="update" action="/hospital/update">
                                    <s:param name="hospitalID">
                                        <s:property value="id"/>
                                    </s:param>
                                </s:url>

                                <s:url var="delete" action="/hospital/delete">
                                    <s:param name="hospitalID">
                                        <s:property value="id"/>
                                    </s:param>
                                </s:url>
                                ...
                                <td><a href="href="<s:property value="#get"/>" class="check"><span class=" glyphicon glyphicon-search"></span>查看</a>
                                    /<a href="href="<s:property value="#update"/>" class="change"><span class="glyphicon glyphicon-pencil"></span>修改</a>
                                    /<a href="href="<s:property value="#delete"/>" class="delete"><span class="glyphicon glyphicon-trash"></span>删除</a>
                                </td>
                            </tr>
                        </s:iterator>
