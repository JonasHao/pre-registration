...
<div class="container" style="overflow:hidden;margin-left:300px;width:100%;padding:0px;">
    <div class="row">
        <div class="col-xs-6">
            ...
            <s:form action="hospital/add" validate="true" class="form-horizontal">
                <s:textfield name="hospitalID" label="医院ID号" maxLength="20" disabled="true" cssClass="form-control"/>
                <s:textfield cssClass="form-control" name="hospitalName" label="医院名字"/>
                <s:textfield cssClass="form-control" name="hospitalAddress_province" label="省份"/>
                <s:textfield cssClass="form-control" name="hospitalAddress_city" label="城市"/>
                <s:textfield cssClass="form-control" name="hospitalAddress_area" label="区"/>
                <s:textfield cssClass="form-control" name="hospitalAddress_detail" label="详细地址"/>
