    ...
    <div class="row">
        <div class="col-xs-6">
            ...
            <s:form action="department/add" validate="true" class="form-horizontal">
                <s:textfield name="id" label="科室ID号" maxLength="20" disabled="true" cssClass="form-control"/>
                <s:textfield cssClass="form-control" name="name" label="科室名字"/>
                <s:textarea cssClass="form-control"  name="description" label="描述"/>
